...
local function OneFile_Print(text)
    PrintChat(string.format("<font color=\"#ff00ff\"><b>[Script TongHop]:</b></font><font color=\"#FFFFFF\"> %s</font>",tostring(text)))
end
...
function OneFile:Hello()
   if self.supported[myHero.charName] ~= nil then
    PrintChat(string.format("<font color=\"#ff00ff\"><b>[Script TongHop]:</b></font><font color=\"#FFFFFF\"> Script tướng đang dùng: %s</font>",self.supported[myHero.charName][self.cfg.c.p:Value()]))
   else
    PrintChat(string.format("<font color=\"#ff00ff\"><b>[Script TongHop]:</b></font><font color=\"#FFFFFF\"> Tướng bạn đang chơi hiện chưa có scipts nào hổ trợ.</font>"))
   end
    PrintChat(string.format("<font color=\"#ff00ff\"><b>[Script TongHop]:</b></font><font color=\"#FFFFFF\"> Script Được Viết Bởi RN.</font>"))
	PrintChat(string.format("<b><font color=\"#80ff00\"> HTTP://ToolLienMinhMienPhi.BlogSpot.Com/</font></b>"))	
end
